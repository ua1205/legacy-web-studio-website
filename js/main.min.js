...
orbs: [
{ c0:[20, 80,120], c1:[ 45,212,191] },
{ c0:[60, 40,140], c1:[139, 92,246] },
{ c0:[10, 60, 80], c1:[ 52,211,153] },
{ c0:[30, 20, 80], c1:[167,139,250] },
{ c0:[15, 50, 70], c1:[ 94,234,212] },
],
orbOpacity: 0.45,
...
setTheme(isDark) {
this.isDark = isDark;
if (!isDark) this.shootingStar = null;
}
_setupObserver() {
...
const speed = sec.w * 0.010;
this.shootingStar = {
x: sec.w * (0.4 + Math.random() * 0.6),
y: sec.h * Math.random() * 0.3,
...
grad.addColorStop(1, 'rgba(94,234,212,0.7)');
sec.ctx.save();
sec.ctx.beginPath();
